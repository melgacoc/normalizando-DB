DROP DATABASE IF EXISTS SpotifyClone;
  ...
  INSERT INTO SpotifyClone.plans (plan_id, plan_title, valor)
  VALUES
    (00.00, 'gratuito'),
    (06.99, 'pessoal'),
    (05.99, 'universiário'),
  ...
  INSERT INTO SpotifyClone.user (user_id, user_name, user_age, plan_id, sigin_date)
  VALUES
    ...
    ('Christopher Alexandre', 85, 2, 2019-06-05),
  ...
  INSERT INTO SpotifyClone.albums (album_id, album_title, artista_id, release_date)
  VALUES
    ('Renaissance', 1, 2022),
    ('Jazz', 2, 1978),
    ('Hot Space', 2, 1982),
  ...
  INSERT INTO SpotifyClone.tracks (track_id, track_name, track_duration, album_id)
  VALUES
